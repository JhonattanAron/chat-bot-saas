...
"[project]/constants/routes.js [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$routes$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/constants/routes.js [app-route] (ecmascript)");
...
;
;
const NEXT_PUBLIC_API_URL = ("TURBOPACK compile-time value", "http://localhost:8081");
const handler = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$auth$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])({
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$auth$2f$providers$2f$credentials$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])({
            ...
            async authorize (credentials) {
                try {
                    ...
                    /* eslint-disable */ console.log(...oo_oo(`3228166917_48_10_48_60_4`, "Estado de la respuesta:", res.status));
                    if (!res.ok) {
                        const errorData = await res.json();
                        /* eslint-disable */ console.error(...oo_tx(`3228166917_52_12_52_58_11`, "Error del backend:", errorData));
                    ...
                    /* eslint-disable */ console.log(...oo_oo(`3228166917_71_10_71_47_4`, "Token extraído:", token));
                    // Decodificar el token JWT para extraer los datos del usuario
                    const decodedToken = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jsonwebtoken$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].decode(token);
                    /* eslint-disable */ console.log(...oo_oo(`3228166917_75_10_75_69_4`, "Datos decodificados del token:", decodedToken));
                    return {
                    ...
                    /* eslint-disable */ console.error(...oo_tx(`3228166917_86_10_86_53_11`, "Error en authorize:", error));
    ...
    callbacks: {
        async signIn ({ user, account }) {
            if (account?.provider === "google") {
                try {
                    ...
                    const response = await fetch(`${("TURBOPACK compile-time value", "http://localhost:8081")}/auth/google-login`, {
                        method: "POST",
                        headers: {
                            "Content-Type": "application/json"
                        },
                    ...
                    /* eslint-disable */ console.log(...oo_oo(`3228166917_118_10_118_37_4`, {
                        data: data
                    }));
                    if (!response.ok) {
                    ...
                    /* eslint-disable */ console.error(...oo_tx(`3228166917_128_10_128_57_11`, "Error en Google SignIn:", error));
                    return false;
                }
            }
            return true;
        ...
        async jwt ({ token, user, account }) {
            if (user) {
                if (account?.provider === "google" && user.token) {
                    ...
                    const decoded = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jsonwebtoken$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].decode(user.token);
                    /* eslint-disable */ console.log(...oo_oo(`3228166917_139_10_139_79_4`, "Token decodificado desde el backend (Google):", decoded));
                    if (decoded) {
                    ...
                    const decoded = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jsonwebtoken$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].decode(user.token);
                    /* eslint-disable */ console.log(...oo_oo(`3228166917_151_10_154_11_4`, "Token decodificado desde el backend (Credentials):", decoded));
                    if (decoded) {
                        token.accessToken = user.token;
                        token.name = decoded.name;
                        token.email = decoded.email;
        ...
        async session ({ session, token }) {
            session.binding_id = token.binding_id;
            return session;
        }
    },
    events: {
        async signIn ({ user, account }) {
            if (account?.provider === "google") {
                try {
                    ...
                    /* eslint-disable */ console.error(...oo_tx(`3228166917_194_10_194_57_11`, "Error en Google SignIn:", error));
                }
            }
        }
    },
    ...
    pages: {
        signIn: __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$routes$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].PUBLIC.LOGIN,
        signOut: __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$routes$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].PUBLIC.LOGIN
    }
});
;
function oo_cm() {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__3f5f5190._.js.map