          ...
          <Tabs defaultValue="basic" className="mb-4">
                  ...
                  <div>
                    ...
                    <CardDescription>
                      {language === "en"
                        ...
                        : "Agregue preguntas y respuestas a las que responderá su chatbot."}
                    </CardDescription>
                  </div>
                            ...
                            <Textarea
                              ...
                              placeholder={
                                language === "en"
                                  ...
                                  : "Nuestro horario de atención es de lunes a viernes, de 9am a 5pm."
                              }
                              className="min-h-[100px]"
                            />
                          </div>
                ...
                <TabsContent value="products">
                  <Card>
                    <CardHeader className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-2 sm:space-y-0">
                      <div>
                        ...
                        <CardDescription>
                          {language === "en"
                            ...
                            : "Agregue productos que su chatbot puede recomendar."}
                        </CardDescription>
                      </div>
                      <Button
                      ...
                      >
                        <Plus className="h-4 w-4" />
                        {language === "en" ? "Add Product" : "Agregar Producto"}
                      </Button>
                    </CardHeader>
                    <CardContent>
                      <div className="flex items-center justify-between mb-4">
                      ...
                      <div>
                        ...
                        <CardDescription>
                          {language === "en"
                            ...
                            : "Agregue funciones y servicios personalizados que su bot puede ejecutar."}
                        </CardDescription>
                      </div>
                      <Button
            ...
            {useCase === "appointments" && (
              <TabsContent value="calendar" className="space-y-4 pt-4">
                <CalendarIntegration language={language as "en" | "es"} />
              </TabsContent>
            )}
          </Tabs>
